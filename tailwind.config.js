...
export default {
    content: [
        ...
        './resources/js/**/*.js',
        // A UI principal está em JS servido de /public
        './public/app/**/*.js',
    ],
    theme: {
        extend: {
            colors: {
                // Landing/marketing (como-funciona)
                primary: '#4f46e5',
                'primary-dark': '#3730a3',
                ...
                // App (public/app/app.js) usa escalas 50-900
                success: {
                    50: '#f0fdf4',
                    100: '#dcfce7',
                    200: '#bbf7d0',
                ...
                // Paletas (copiadas do antigo twind.install do welcome)
                primaryScale: {
                    50: '#f5f3ff',
                    100: '#ede9fe',
                    200: '#ddd6fe',
