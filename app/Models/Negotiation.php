...
class Negotiation extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'internal_logs' => 'array',
            'buyer_invite_inputs' => 'array',
            'buyer_invite_confirmations' => 'array',
            'buyer_invite_availability' => 'array',
            'buyer_invite_access' => 'array',
            'buyer_invite_proofs' => 'array',
            ...
            'buyer_invite_submitted_at' => 'datetime',
            'buyer_request_changes_at' => 'datetime',
            'buyer_reported_at' => 'datetime',
